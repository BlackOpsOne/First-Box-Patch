...
These checksums were generated with the anticheat on Plutonium turned off, so that a hooked timer could work, as well as only the first box patch, no further modification was done.
